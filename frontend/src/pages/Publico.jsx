  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-16 px-4 sm:px-8 lg:px-12 w-full pt-6 md:pt-12">
      ...
      <header className="text-center mb-8 md:mb-12">
        ...
        <div className="grid grid-cols-2 md:flex md:flex-row md:flex-nowrap items-center justify-center gap-2 md:gap-3 text-xs sm:text-sm text-slate-300 mt-5 font-medium max-w-xl md:max-w-none mx-auto w-full md:w-auto px-1 sm:px-0">
          {/* Fecha */}
          <div className="flex items-center justify-center md:shrink-0 gap-1.5 px-3 py-2 md:py-1.5 rounded-xl md:rounded-full bg-slate-900/80 border border-slate-800 text-slate-300 shadow-sm backdrop-blur-sm whitespace-nowrap">
          ...
          <div className={`flex items-center justify-center md:shrink-0 gap-1.5 px-3 py-2 md:py-1.5 rounded-xl md:rounded-full shadow-sm backdrop-blur-sm whitespace-nowrap ${
            !datos.cantidad_asistentes ? 'col-span-2 md:col-span-1' : ''
          } ${
            esVerificado
