  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans pb-16 px-4 sm:px-8 lg:px-12 w-full pt-6 md:pt-12">
      ...
      <header className="text-center mb-8 md:mb-12">
        ...
        <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-300 mt-5 font-medium max-w-xl mx-auto w-full px-1 sm:px-0">
          {/* Fecha */}
          <div className="flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded-xl sm:rounded-full bg-slate-900/80 border border-slate-800 text-slate-300 shadow-sm backdrop-blur-sm">
            ...
            <span className="truncate">{datos.fecha}</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded-xl sm:rounded-full bg-slate-900/80 border border-slate-800 text-slate-300 shadow-sm backdrop-blur-sm">
            ...
            <span className="truncate">{datos.ciudad}, {datos.pais}</span>
          </div>
          ...
          {Boolean(datos.cantidad_asistentes) && (
            <div className="flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded-xl sm:rounded-full bg-slate-900/80 border border-slate-800 text-slate-300 shadow-sm backdrop-blur-sm">
              ...
              <span className="truncate">{Number(datos.cantidad_asistentes).toLocaleString()} asistentes</span>
            </div>
          )}

          {/* Estado del Cálculo: Verificado vs Estimado */}
          <div className={`flex items-center justify-center gap-1.5 px-3 py-2 sm:py-1.5 rounded-xl sm:rounded-full shadow-sm backdrop-blur-sm ${
            !datos.cantidad_asistentes ? 'col-span-2 sm:col-span-1' : ''
          } ${
            esVerificado
            ...
            {esVerificado ? (
              <>
                ...
                <span className="truncate">Cálculo verificado</span>
              </>
            ) : (
              <>
                <svg className="w-4 h-4 text-emerald-400 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                <span className="truncate">Cálculo estimado</span>
              </>
            )}
          </div>
        </div>
